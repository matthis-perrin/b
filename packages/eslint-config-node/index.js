...
export default [
  {ignores: ['**/*.js', '**/*.cjs', '**/*.mjs']},
  {
    ...
    settings: {
      ...
      'node/parsers': {'@typescript-eslint/parser': ['.ts', '.tsx']},
      'node/extensions': ['.ts', '.tsx'],
      'node/resolver': {typescript: {project: './tsconfig.json'}},
    },
    rules: {
      ...
      'n/no-unsupported-features/es-builtins': ['warn', {version: '>=20.10'}],
      'n/no-unsupported-features/es-syntax': ['warn', {version: '>=20.10'}],
      'n/no-unsupported-features/node-builtins': ['warn', {version: '>=20.10'}],
